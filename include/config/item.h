...
#define I_EXP_SHARE_FLAG        0x0AF       // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define VAR_LAST_REPEL_LURE_USED    0x4090  // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
...
#define I_ORAS_DOWSING_FLAG         0x31D                 // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.
