...
#define AI_FLAG_TEAM_SYNERGY                AI_FLAG(34)  // AI scores moves by how they benefit its party reserves (weather cover, screens, terrain, sacrifices), not just the active mon.
