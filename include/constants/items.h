...
enum __attribute__((packed)) Item
{
    ...
    // Charms
    ITEM_OVAL_CHARM = 745,
    ITEM_SHINY_CHARM = 746,
    ITEM_CATCHING_CHARM = 747,
    ITEM_EXP_CHARM = 748,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 749,
    ITEM_GRACIDEA = 750,
    ITEM_REVEAL_GLASS = 751,
    ITEM_DNA_SPLICERS = 752,
    ITEM_ZYGARDE_CUBE = 753,
    ITEM_PRISON_BOTTLE = 754,
    ITEM_N_SOLARIZER = 755,
    ITEM_N_LUNARIZER = 756,
    ITEM_REINS_OF_UNITY = 757,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 758,
    ITEM_Z_POWER_RING = 759,
    ITEM_DYNAMAX_BAND = 760,
    ...
    ITEM_GOOD_ROD = 765,
    ITEM_SUPER_ROD = 766,
    ITEM_DOWSING_MACHINE = 767,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 768,
    ITEM_VS_SEEKER = 769,
    ITEM_TM_CASE = 770,
    ITEM_BERRY_POUCH = 771,
    ITEM_POKEMON_BOX_LINK = 772,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 773,
    ITEM_POWDER_JAR = 774,
    ITEM_WAILMER_PAIL = 775,
    ITEM_POKE_RADAR = 776,
    ITEM_POKEBLOCK_CASE = 777,
    ITEM_SOOT_SACK = 778,
    ITEM_POKE_FLUTE = 779,
    ITEM_FAME_CHECKER = 780,
    ITEM_TEACHY_TV = 781,

    // Story Key Items
    ITEM_SS_TICKET = 782,
    ITEM_EON_TICKET = 783,
    ITEM_MYSTIC_TICKET = 784,
    ITEM_AURORA_TICKET = 785,
    ITEM_OLD_SEA_MAP = 786,
    ITEM_LETTER = 787,
    ITEM_DEVON_PARTS = 788,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 789,
    ITEM_DEVON_SCOPE = 790,
    ITEM_BASEMENT_KEY = 791,
    ITEM_SCANNER = 792,
    ITEM_STORAGE_KEY = 793,
    ITEM_KEY_TO_ROOM_1 = 794,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 795,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 796,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 797,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Pre-Gen VI name
    ITEM_METEORITE = 798,
    ITEM_MAGMA_EMBLEM = 799,
    ITEM_CONTEST_PASS = 800,
    ITEM_PARCEL = 801,
    ITEM_OAKS_PARCEL = ITEM_PARCEL, // Pre-Gen IV name
    ITEM_SECRET_KEY = 802,
    ITEM_BIKE_VOUCHER = 803,
    ITEM_GOLD_TEETH = 804,
    ITEM_CARD_KEY = 805,
    ITEM_LIFT_KEY = 806,
    ITEM_SILPH_SCOPE = 807,
    ITEM_TRI_PASS = 808,
    ITEM_RAINBOW_PASS = 809,
    ITEM_TEA = 810,
    ITEM_RUBY = 811,
    ITEM_SAPPHIRE = 812,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 813,
    ITEM_CLEAR_AMULET = 814,
    ITEM_PUNCHING_GLOVE = 815,
    ITEM_COVERT_CLOAK = 816,
    ITEM_LOADED_DICE = 817,
    ITEM_AUSPICIOUS_ARMOR = 818,
    ITEM_BOOSTER_ENERGY = 819,
    ITEM_BIG_BAMBOO_SHOOT = 820,
    ITEM_GIMMIGHOUL_COIN = 821,
    ITEM_LEADERS_CREST = 822,
    ITEM_MALICIOUS_ARMOR = 823,
    ITEM_MIRROR_HERB = 824,
    ITEM_SCROLL_OF_DARKNESS = 825,
    ITEM_SCROLL_OF_WATERS = 826,
    ITEM_TERA_ORB = 827,
    ITEM_TINY_BAMBOO_SHOOT = 828,

    ITEM_BUG_TERA_SHARD = 829,
    ITEM_DARK_TERA_SHARD = 830,
    ITEM_DRAGON_TERA_SHARD = 831,
    ITEM_ELECTRIC_TERA_SHARD = 832,
    ITEM_FAIRY_TERA_SHARD = 833,
    ITEM_FIGHTING_TERA_SHARD = 834,
    ITEM_FIRE_TERA_SHARD = 835,
    ITEM_FLYING_TERA_SHARD = 836,
    ITEM_GHOST_TERA_SHARD = 837,
    ITEM_GRASS_TERA_SHARD = 838,
    ITEM_GROUND_TERA_SHARD = 839,
    ITEM_ICE_TERA_SHARD = 840,
    ITEM_NORMAL_TERA_SHARD = 841,
    ITEM_POISON_TERA_SHARD = 842,
    ITEM_PSYCHIC_TERA_SHARD = 843,
    ITEM_ROCK_TERA_SHARD = 844,
    ITEM_STEEL_TERA_SHARD = 845,
    ITEM_WATER_TERA_SHARD = 846,

    ITEM_ADAMANT_CRYSTAL = 847,
    ITEM_GRISEOUS_CORE = 848,
    ITEM_LUSTROUS_GLOBE = 849,

    ITEM_BLACK_AUGURITE = 850,
    ITEM_LINKING_CORD = 851,
    ITEM_PEAT_BLOCK = 852,
    ITEM_BERSERK_GENE = 853,

    ITEM_FAIRY_FEATHER = 854,
    ITEM_SYRUPY_APPLE = 855,
    ITEM_UNREMARKABLE_TEACUP = 856,
    ITEM_MASTERPIECE_TEACUP = 857,
    ITEM_CORNERSTONE_MASK = 858,
    ITEM_WELLSPRING_MASK = 859,
    ITEM_HEARTHFLAME_MASK = 860,
    ITEM_HEALTH_MOCHI = 861,
    ITEM_MUSCLE_MOCHI = 862,
    ITEM_RESIST_MOCHI = 863,
    ITEM_GENIUS_MOCHI = 864,
    ITEM_CLEVER_MOCHI = 865,
    ITEM_SWIFT_MOCHI = 866,
    ITEM_FRESH_START_MOCHI = 867,
    ITEM_GLIMMERING_CHARM = 868,
    ITEM_METAL_ALLOY = 869,
    ITEM_STELLAR_TERA_SHARD = 870,

    ITEM_JUBILIFE_MUFFIN = 871,
    ITEM_REMEDY = 872,
    ITEM_FINE_REMEDY = 873,
    ITEM_SUPERB_REMEDY = 874,
    ITEM_AUX_EVASION = 875,
    ITEM_AUX_GUARD = 876,
    ITEM_AUX_POWER = 877,
    ITEM_AUX_POWERGUARD = 878,
    ITEM_CHOICE_DUMPLING = 879,
    ITEM_SWAP_SNACK = 880,
    ITEM_TWICE_SPICED_RADISH = 881,
    ITEM_POKESHI_DOLL = 882,

    ITEM_STRANGE_BALL = 883,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 884,
    ITEM_VICTREEBELITE = 885,
    ITEM_STARMINITE = 886,
    ITEM_DRAGONINITE = 887,
    ITEM_MEGANIUMITE = 888,
    ITEM_FERALIGITE = 889,
    ITEM_SKARMORITE = 890,
    ITEM_FROSLASSITE = 891,
    ITEM_EMBOARITE = 892,
    ITEM_EXCADRITE = 893,
    ITEM_SCOLIPITE = 894,
    ITEM_SCRAFTINITE = 895,
    ITEM_EELEKTROSSITE = 896,
    ITEM_CHANDELURITE = 897,
    ITEM_CHESNAUGHTITE = 898,
    ITEM_DELPHOXITE = 899,
    ITEM_GRENINJITE = 900,
    ITEM_PYROARITE = 901,
    ITEM_FLOETTITE = 902,
    ITEM_MALAMARITE = 903,
    ITEM_BARBARACITE = 904,
    ITEM_DRAGALGITE = 905,
    ITEM_HAWLUCHANITE = 906,
    ITEM_ZYGARDITE = 907,
    ITEM_DRAMPANITE = 908,
    ITEM_FALINKSITE = 909,
    ...
    ITEM_DARKRANITE = 920,
    ITEM_ZERAORITE = 921,
    ITEM_RAICHUNITE_X = 922,
    ITEM_RAICHUNITE_Y = 923,
    ITEM_CHIMECHITE = 924,
    ITEM_ABSOLITE_Z = 925,
    ITEM_STARAPTITE = 926,
    ITEM_GARCHOMPITE_Z = 927,
    ITEM_LUCARIONITE_Z = 928,
    ITEM_GOLURKITE = 929,
    ITEM_MEOWSTICITE = 930,
    ITEM_CRABOMINITE = 931,
    ITEM_GOLISOPITE = 932,
    ITEM_MAGEARNITE = 933,
    ITEM_SCOVILLAINITE = 934,
    ITEM_BAXCALIBRITE = 935,
    ITEM_TATSUGIRINITE = 936,
    ITEM_GLIMMORANITE = 937,
