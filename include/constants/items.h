...
enum __attribute__((packed)) Item
{
    ...
    ITEM_DARKRANITE = 914,
    ITEM_ZERAORITE = 915,
    ITEM_RAICHUNITE_X = 916,
    ITEM_RAICHUNITE_Y = 917,
    ITEM_CHIMECHITE = 918,
    ITEM_ABSOLITE_Z = 919,
    ITEM_STARAPTITE = 920,
    ITEM_GARCHOMPITE_Z = 921,
    ITEM_LUCARIONITE_Z = 922,
    ITEM_GOLURKITE = 923,
    ITEM_MEOWSTICITE = 924,
    ITEM_CRABOMINITE = 925,
    ITEM_GOLISOPITE = 926,
    ITEM_MAGEARNITE = 927,
    ITEM_SCOVILLAINITE = 928,
    ITEM_BAXCALIBRITE = 929,
    ITEM_TATSUGIRINITE = 930,
    ITEM_GLIMMORANITE = 931,
