...
enum __attribute__((packed)) Item
{
    ...
    ITEM_DARKRANITE = 912,
    ITEM_ZERAORITE = 913,
    ITEM_RAICHUNITE_X = 914,
    ITEM_RAICHUNITE_Y = 915,
    ITEM_CHIMECHITE = 916,
    ITEM_ABSOLITE_Z = 917,
    ITEM_STARAPTITE = 918,
    ITEM_GARCHOMPITE_Z = 919,
    ITEM_LUCARIONITE_Z = 920,
    ITEM_GOLURKITE = 921,
    ITEM_MEOWSTICITE = 922,
    ITEM_CRABOMINITE = 923,
    ITEM_GOLISOPITE = 924,
    ITEM_MAGEARNITE = 925,
    ITEM_SCOVILLAINITE = 926,
    ITEM_BAXCALIBRITE = 927,
    ITEM_TATSUGIRINITE = 928,
    ITEM_GLIMMORANITE = 929,
