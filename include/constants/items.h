...
enum __attribute__((packed)) Item
{
    ...
    ITEM_DARKRANITE = 913,
    ITEM_ZERAORITE = 914,
    ITEM_RAICHUNITE_X = 915,
    ITEM_RAICHUNITE_Y = 916,
    ITEM_CHIMECHITE = 917,
    ITEM_ABSOLITE_Z = 918,
    ITEM_STARAPTITE = 919,
    ITEM_GARCHOMPITE_Z = 920,
    ITEM_LUCARIONITE_Z = 921,
    ITEM_GOLURKITE = 922,
    ITEM_MEOWSTICITE = 923,
    ITEM_CRABOMINITE = 924,
    ITEM_GOLISOPITE = 925,
    ITEM_MAGEARNITE = 926,
    ITEM_SCOVILLAINITE = 927,
    ITEM_BAXCALIBRITE = 928,
    ITEM_TATSUGIRINITE = 929,
    ITEM_GLIMMORANITE = 930,
