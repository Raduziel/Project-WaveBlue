...
enum __attribute__((packed)) Item
{
    ...
    ITEM_DARKRANITE = 921,
    ITEM_ZERAORITE = 922,
    ITEM_RAICHUNITE_X = 923,
    ITEM_RAICHUNITE_Y = 924,
    ITEM_CHIMECHITE = 925,
    ITEM_ABSOLITE_Z = 926,
    ITEM_STARAPTITE = 927,
    ITEM_GARCHOMPITE_Z = 928,
    ITEM_LUCARIONITE_Z = 929,
    ITEM_GOLURKITE = 930,
    ITEM_MEOWSTICITE = 931,
    ITEM_CRABOMINITE = 932,
    ITEM_GOLISOPITE = 933,
    ITEM_MAGEARNITE = 934,
    ITEM_SCOVILLAINITE = 935,
    ITEM_BAXCALIBRITE = 936,
    ITEM_TATSUGIRINITE = 937,
    ITEM_GLIMMORANITE = 938,
