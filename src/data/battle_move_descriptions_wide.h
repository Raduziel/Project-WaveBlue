...
const u8 *const gBattleMoveDescriptionsWide[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DISARM_VOICE] = sMoveDescription_DisarmingVoice,
    ...
    [MOVE_DAZZLE_GLEAM] = sMoveDescription_DazzlingGleam,
    ...
    [MOVE_SCORCHING_SAND] = sMoveDescription_ScorchingSand,
    ...
    [MOVE_ALLURE_VOICE] = sMoveDescription_AlluringVoice,
