...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_PERSIAN},
                                {EVO_LEVEL, 28, SPECIES_PERRSERKER, CONDITIONS({IF_HOLD_ITEM, ITEM_METAL_COAT})}),
    },
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MACHAMP, CONDITIONS({IF_HOLD_ITEM, ITEM_MACHO_BRACE})}),
    },
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MAGNEZONE, CONDITIONS({IF_HOLD_ITEM, ITEM_MAGNET})}),
    #endif
    },
