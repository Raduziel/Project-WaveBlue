...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_BATTLE_END, 0, SPECIES_ANNIHILAPE, CONDITIONS({IF_USED_MOVE_X_TIMES, MOVE_RAGE_FIST, 21})}),
    #endif
    },
    ...
    [SPECIES_KADABRA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ALAKAZAM}),
    },
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_MACHO_BRACE, SPECIES_MACHAMP}),
    },
    ...
    [SPECIES_GRAVELER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_HARD_STONE, SPECIES_GOLEM}),
    },
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_MAGNET, SPECIES_MAGNEZONE}),
    #endif
    },
