...
static const u8 sText_Stats_EggCycles_VeryFast[] = _("{EMOJI_BOLT}{EMOJI_BOLT}");
static const u8 sText_Stats_EggCycles_Fast[] = _("{EMOJI_BOLT}");
static const u8 sText_Stats_EggCycles_Normal[] = _("{EMOJI_BOLT}{EMOJI_BOLT}");
static const u8 sText_Stats_EggCycles_Slow[] = _("{EMOJI_BOLT}{EMOJI_BOLT}{EMOJI_BOLT}");
