...
static const struct RenewableHiddenItemData sRenewableHiddenItems[] = {
    ...
    },
    {
        ...
        .rare = {
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_FIGY_BERRY),
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_MAGO_BERRY),
            ...
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_AGUAV_BERRY),
        ...
        .common = {
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_IAPAPA_BERRY),
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WIKI_BERRY),
