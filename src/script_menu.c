...
static const struct MenuAction sMultichoiceList_HyperStats[] = {
    { gText_HP },
    { gText_Attack },
    { gText_Defense },
    { gText_SpAtk },
...
static const struct MenuAction sMultichoiceList_HyperCapChoice[] = {
    { gText_UseBottleCap },
...
static const struct MenuAction sMultichoiceList_BattlePalaceRules[] =
{
    ...
    {COMPOUND_STRING("Pokémon Natures")},
...
//  [MULTI_GAME_CORNER_BATTLE_ITEM_PRIZES]             = MULTICHOICE(sMultichoiceList_GameCornerBattleItemPrizes),
    ...
    [MULTI_HYPER_CAP_CHOICE]                           = MULTICHOICE(sMultichoiceList_HyperCapChoice),
    [MULTI_HYPER_STATS]                                = MULTICHOICE(sMultichoiceList_HyperStats),
    [MULTI_GAME_CORNER_CLERK_LEFT]                     = MULTICHOICE(sMultichoiceList_GameCornerClerkLeft),
    [MULTI_GAME_CORNER_CLERK_RIGHT]                    = MULTICHOICE(sMultichoiceList_GameCornerClerkRight),
