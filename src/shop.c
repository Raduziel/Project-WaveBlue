...
static const struct OneTimeShopItem sOneTimeTMs[] = {
    {ITEM_TM_SIGNAL_BEAM,      FLAG_BOUGHT_TM51,  TYPE_BUG},
    {ITEM_TM_BUG_BUZZ,         FLAG_BOUGHT_TM52,  TYPE_BUG},
    {ITEM_TM_LEECH_LIFE,       FLAG_BOUGHT_TM53,  TYPE_BUG},
    {ITEM_TM_POLLEN_PUFF,      FLAG_BOUGHT_TM54,  TYPE_BUG},
    {ITEM_TM_STRUGGLE_BUG,     FLAG_BOUGHT_TM55,  TYPE_BUG},
    {ITEM_TM_U_TURN,           FLAG_BOUGHT_TM56,  TYPE_BUG},
    {ITEM_TM_X_SCISSOR,        FLAG_BOUGHT_TM57,  TYPE_BUG},
    {ITEM_TM_STICKY_WEB,       FLAG_BOUGHT_TM58,  TYPE_BUG},
    {ITEM_TM_LUNGE,            FLAG_BOUGHT_TM59,  TYPE_BUG},
    {ITEM_TM_HONE_CLAWS,       FLAG_BOUGHT_TM60,  TYPE_DARK},
    {ITEM_TM_THROAT_CHOP,      FLAG_BOUGHT_TM61,  TYPE_DARK},
    {ITEM_TM_CRUNCH,           FLAG_BOUGHT_TM62,  TYPE_DARK},
    {ITEM_TM_DARK_PULSE,       FLAG_BOUGHT_TM63,  TYPE_DARK},
    {ITEM_TM_FAKE_TEARS,       FLAG_BOUGHT_TM64,  TYPE_DARK},
    {ITEM_TM_FOUL_PLAY,        FLAG_BOUGHT_TM65,  TYPE_DARK},
    {ITEM_TM_KNOCK_OFF,        FLAG_BOUGHT_TM66,  TYPE_DARK},
    {ITEM_TM_NASTY_PLOT,       FLAG_BOUGHT_TM67,  TYPE_DARK},
    {ITEM_TM_SNARL,            FLAG_BOUGHT_TM68,  TYPE_DARK},
    {ITEM_TM_DRAGON_TAIL,      FLAG_BOUGHT_TM69,  TYPE_DRAGON},
    {ITEM_TM_OUTRAGE,          FLAG_BOUGHT_TM70,  TYPE_DRAGON},
    {ITEM_TM_SCALE_SHOT,       FLAG_BOUGHT_TM71,  TYPE_DRAGON},
    {ITEM_TM_BREAKING_SWIPE,   FLAG_BOUGHT_TM72,  TYPE_DRAGON},
    {ITEM_TM_CHARGE_BEAM,      FLAG_BOUGHT_TM73,  TYPE_ELECTRIC},
    {ITEM_TM_ELECTRIC_TERRAIN, FLAG_BOUGHT_TM74,  TYPE_ELECTRIC},
    {ITEM_TM_VOLT_SWITCH,      FLAG_BOUGHT_TM75,  TYPE_ELECTRIC},
    {ITEM_TM_WILD_CHARGE,      FLAG_BOUGHT_TM76,  TYPE_ELECTRIC},
    {ITEM_TM_ELECTROWEB,       FLAG_BOUGHT_TM77,  TYPE_ELECTRIC},
    {ITEM_TM_THUNDER_WAVE,     FLAG_BOUGHT_TM78,  TYPE_ELECTRIC},
    {ITEM_TM_ALLURING_VOICE,   FLAG_BOUGHT_TM79,  TYPE_FAIRY},
    {ITEM_TM_DAZZLING_GLEAM,   FLAG_BOUGHT_TM80,  TYPE_FAIRY},
    {ITEM_TM_DRAINING_KISS,    FLAG_BOUGHT_TM81,  TYPE_FAIRY},
    {ITEM_TM_MISTY_TERRAIN,    FLAG_BOUGHT_TM82,  TYPE_FAIRY},
    {ITEM_TM_PLAY_ROUGH,       FLAG_BOUGHT_TM83,  TYPE_FAIRY},
    {ITEM_TM_AURA_SPHERE,      FLAG_BOUGHT_TM84,  TYPE_FIGHTING},
    {ITEM_TM_BODY_PRESS,       FLAG_BOUGHT_TM85,  TYPE_FIGHTING},
    {ITEM_TM_CLOSE_COMBAT,     FLAG_BOUGHT_TM86,  TYPE_FIGHTING},
    {ITEM_TM_DRAIN_PUNCH,      FLAG_BOUGHT_TM87,  TYPE_FIGHTING},
    {ITEM_TM_VACUUM_WAVE,      FLAG_BOUGHT_TM88,  TYPE_FIGHTING},
    {ITEM_TM_LOW_SWEEP,        FLAG_BOUGHT_TM89,  TYPE_FIGHTING},
    {ITEM_TM_FLAME_CHARGE,     FLAG_BOUGHT_TM90,  TYPE_FIRE},
    {ITEM_TM_FLARE_BLITZ,      FLAG_BOUGHT_TM91,  TYPE_FIRE},
    {ITEM_TM_WILL_O_WISP,      FLAG_BOUGHT_TM92,  TYPE_FIRE},
    {ITEM_TM_ACROBATICS,       FLAG_BOUGHT_TM93,  TYPE_FLYING},
    {ITEM_TM_AIR_SLASH,        FLAG_BOUGHT_TM94,  TYPE_FLYING},
    {ITEM_TM_BRAVE_BIRD,       FLAG_BOUGHT_TM95,  TYPE_FLYING},
    {ITEM_TM_HURRICANE,        FLAG_BOUGHT_TM96,  TYPE_FLYING},
    {ITEM_TM_ROOST,            FLAG_BOUGHT_TM97,  TYPE_FLYING},
    {ITEM_TM_TAILWIND,         FLAG_BOUGHT_TM98,  TYPE_FLYING},
    {ITEM_TM_DRILL_PECK,       FLAG_BOUGHT_TM99,  TYPE_FLYING},
    {ITEM_TM_DUAL_WINGBEAT,    FLAG_BOUGHT_TM100, TYPE_FLYING},
    {ITEM_TM_HEX,              FLAG_BOUGHT_TM101, TYPE_GHOST},
    {ITEM_TM_PHANTOM_FORCE,    FLAG_BOUGHT_TM102, TYPE_GHOST},
    {ITEM_TM_SHADOW_CLAW,      FLAG_BOUGHT_TM103, TYPE_GHOST},
    {ITEM_TM_ENERGY_BALL,      FLAG_BOUGHT_TM104, TYPE_GRASS},
    {ITEM_TM_GRASSY_TERRAIN,   FLAG_BOUGHT_TM105, TYPE_GRASS},
    {ITEM_TM_SEED_BOMB,        FLAG_BOUGHT_TM106, TYPE_GRASS},
    {ITEM_TM_TRAILBLAZE,       FLAG_BOUGHT_TM107, TYPE_GRASS},
    {ITEM_TM_SOLAR_BLADE,      FLAG_BOUGHT_TM108, TYPE_GRASS},
    {ITEM_TM_BULLDOZE,         FLAG_BOUGHT_TM109, TYPE_GROUND},
    {ITEM_TM_EARTH_POWER,      FLAG_BOUGHT_TM110, TYPE_GROUND},
    {ITEM_TM_SPIKES,           FLAG_BOUGHT_TM111, TYPE_GROUND},
    {ITEM_TM_DRILL_RUN,        FLAG_BOUGHT_TM112, TYPE_GROUND},
    {ITEM_TM_SCORCHING_SANDS,   FLAG_BOUGHT_TM113, TYPE_GROUND},
    {ITEM_TM_MUD_SHOT,         FLAG_BOUGHT_TM114, TYPE_GROUND},
    {ITEM_TM_AVALANCHE,        FLAG_BOUGHT_TM115, TYPE_ICE},
    {ITEM_TM_ICE_SPINNER,      FLAG_BOUGHT_TM116, TYPE_ICE},
    {ITEM_TM_ICICLE_SPEAR,     FLAG_BOUGHT_TM117, TYPE_ICE},
    {ITEM_TM_ICY_WIND,         FLAG_BOUGHT_TM118, TYPE_ICE},
    {ITEM_TM_ACID_SPRAY,       FLAG_BOUGHT_TM119, TYPE_POISON},
    {ITEM_TM_POISON_JAB,       FLAG_BOUGHT_TM120, TYPE_POISON},
    {ITEM_TM_TOXIC_SPIKES,     FLAG_BOUGHT_TM121, TYPE_POISON},
    {ITEM_TM_POISON_FANG,      FLAG_BOUGHT_TM122, TYPE_POISON},
    {ITEM_TM_PSYCHIC_FANGS,    FLAG_BOUGHT_TM123, TYPE_PSYCHIC},
    {ITEM_TM_PSYCHIC_TERRAIN,  FLAG_BOUGHT_TM124, TYPE_PSYCHIC},
    {ITEM_TM_PSYCHO_CUT,       FLAG_BOUGHT_TM125, TYPE_PSYCHIC},
    {ITEM_TM_ZEN_HEADBUTT,     FLAG_BOUGHT_TM126, TYPE_PSYCHIC},
    {ITEM_TM_PSYSHOCK,         FLAG_BOUGHT_TM127, TYPE_PSYCHIC},
    {ITEM_TM_TRICK_ROOM,       FLAG_BOUGHT_TM128, TYPE_PSYCHIC},
    {ITEM_TM_POWER_GEM,        FLAG_BOUGHT_TM129, TYPE_ROCK},
    {ITEM_TM_ROCK_BLAST,       FLAG_BOUGHT_TM130, TYPE_ROCK},
    {ITEM_TM_STEALTH_ROCK,     FLAG_BOUGHT_TM131, TYPE_ROCK},
    {ITEM_TM_STONE_EDGE,       FLAG_BOUGHT_TM132, TYPE_ROCK},
    {ITEM_TM_MAGNET_BOMB,      FLAG_BOUGHT_TM133, TYPE_STEEL},
    {ITEM_TM_FLASH_CANNON,     FLAG_BOUGHT_TM134, TYPE_STEEL},
    {ITEM_TM_HEAVY_SLAM,       FLAG_BOUGHT_TM135, TYPE_STEEL},
    {ITEM_TM_IRON_HEAD,        FLAG_BOUGHT_TM136, TYPE_STEEL},
    {ITEM_TM_SMART_STRIKE,     FLAG_BOUGHT_TM137, TYPE_STEEL},
    {ITEM_TM_CHILLING_WATER,   FLAG_BOUGHT_TM138, TYPE_WATER},
    {ITEM_TM_LIQUIDATION,      FLAG_BOUGHT_TM139, TYPE_WATER},
    {ITEM_TM_SCALD,            FLAG_BOUGHT_TM140, TYPE_WATER},
