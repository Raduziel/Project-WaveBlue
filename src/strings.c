...
const u8 gText_LiftBeltOn[]  = _("{PLAYER} put the Lift Belt on!\nHeavy boulders can be pushed!{PAUSE_UNTIL_PRESS}");
const u8 gText_LiftBeltOff[] = _("{PLAYER} took off the Lift Belt.\nBoulders can't be pushed now.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedRubberBoat[] = _("{PLAYER} inflated the\nRubber Boat!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ChoiceBand_5000[]   = _("Choice Band{CLEAR_TO 0x50}{FONT_SMALL}5000");
const u8 gText_ChoiceSpecs_5000[]  = _("Choice Specs{CLEAR_TO 0x50}{FONT_SMALL}5000");
...
const u8 gText_FlameOrb_1000[]     = _("Flame Orb{CLEAR_TO 0x50}{FONT_SMALL}1000");
const u8 gText_ToxicOrb_1000[]     = _("Toxic Orb{CLEAR_TO 0x50}{FONT_SMALL}1000");
const u8 gText_FocusSash_2500[]    = _("Focus Sash{CLEAR_TO 0x50}{FONT_SMALL}2500");
const u8 gText_BrightPowder_1500[] = _("Bright Powder{CLEAR_TO 0x50}{FONT_SMALL}1500");
const u8 gText_MuscleBand_500[]   = _("Muscle Band{CLEAR_TO 0x50}{FONT_SMALL}500");
const u8 gText_WiseGlasses_500[]  = _("Wise Glasses{CLEAR_TO 0x50}{FONT_SMALL}500");
const u8 gText_ProtectPads_1000[]   = _("Protect Pads{CLEAR_TO 0x50}{FONT_SMALL}1000");
const u8 gText_Metronome_1000[]    = _("Metronome{CLEAR_TO 0x50}{FONT_SMALL}1000");
const u8 gText_CovertCloak_1500[]  = _("Covert Cloak{CLEAR_TO 0x50}{FONT_SMALL}1500");
const u8 gText_WideLens_1500[]     = _("Wide Lens{CLEAR_TO 0x50}{FONT_SMALL}1500");
const u8 gText_ExpertBelt_2000[]    = _("Expert Belt{CLEAR_TO 0x50}{FONT_SMALL}2000");
const u8 gText_ThroatSpray_1500[]  = _("Throat Spray{CLEAR_TO 0x50}{FONT_SMALL}1500");
const u8 gText_LightClay_1500[]    = _("Light Clay{CLEAR_TO 0x50}{FONT_SMALL}1500");
