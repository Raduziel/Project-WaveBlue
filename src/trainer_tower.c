...
static const enum Item sPrizeList[] =
{
    ...
    [TTPRIZE_FOCUS_SASH]      = ITEM_FOCUS_SASH,
    [TTPRIZE_WEAKNESS_POLICY] = ITEM_WEAKNESS_POLICY,
    [TTPRIZE_LIFE_ORB]        = ITEM_LIFE_ORB,
    [TTPRIZE_CHOICE_BAND]     = ITEM_CHOICE_BAND,
    [TTPRIZE_EVIOLITE]        = ITEM_EVIOLITE,
    [TTPRIZE_SCOPE_LENS]      = ITEM_SCOPE_LENS,
    [TTPRIZE_ASSAULT_VEST]    = ITEM_ASSAULT_VEST,
    [TTPRIZE_CHOICE_SCARF]    = ITEM_CHOICE_SCARF,
    [TTPRIZE_CHOICE_SPECS]    = ITEM_CHOICE_SPECS,
};
